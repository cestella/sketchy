...
public class WindowParser extends Parser {
  ...
  public static final int COMMA = 1, COLON = 2, WINDOW = 3, INCLUDE = 4, EXCLUDE = 5, FROM = 6,
      EVERY = 7, TO = 8, AGO = 9, NUMBER = 10, IDENTIFIER = 11, DAY_SPECIFIER = 12, TIME_UNIT = 13,
      WS = 14;
  public static final int RULE_window = 0, RULE_window_expression = 1, RULE_excluding_specifier = 2,
      ...
      RULE_day_specifier = 6, RULE_identifier = 7, RULE_specifier_list = 8, RULE_duration = 9,
      RULE_skip_distance = 10, RULE_window_width = 11, RULE_time_interval = 12,
      RULE_time_amount = 13, RULE_time_unit = 14;
  public static final String[] ruleNames =
      {"window", "window_expression", "excluding_specifier", "including_specifier", "specifier",
          "specifier_arg_list", "day_specifier", "identifier", "specifier_list", "duration",
          "skip_distance", "window_width", "time_interval", "time_amount", "time_unit"};

  private static final String[] _LITERAL_NAMES = {null, "','", "':'"};
  private static final String[] _SYMBOLIC_NAMES =
      {null, "COMMA", "COLON", "WINDOW", "INCLUDE", "EXCLUDE", "FROM", "EVERY", "TO", "AGO",
          "NUMBER", "IDENTIFIER", "DAY_SPECIFIER", "TIME_UNIT", "WS"};
