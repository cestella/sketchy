...
public class StellarAssignment implements Map.Entry<String, Object> {
   ...
   * map (by the iterator's <tt>remove</tt> operation), the results of this call are undefined.
   *
   ...
   * been removed from the map (by the iterator's <tt>remove</tt> operation).
   *
   ...
   *         the backing map
   * @throws NullPointerException if the backing map does not permit null values, and the specified
   *         value is null
