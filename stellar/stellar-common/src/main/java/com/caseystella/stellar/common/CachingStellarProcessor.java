...
public class CachingStellarProcessor extends StellarProcessor {
    ...
    public static class Key {
        ...
        public boolean equals(Object o) {
            ...
            Key key = (Key) o;
            return new EqualsBuilder().append(expression, key.expression).append(input, key.input).isEquals();
        }
    ...
    /**
     * Parses and evaluates the given Stellar expression, {@code expression}. Results will be taken from a cache if
     * possible.
     *
     * @param expression
    ...
    public Object parse(String expression, VariableResolver variableResolver, FunctionResolver functionResolver,
            Context context) {
    ...
    public static Cache<Key, Object> createCache(Map<String, Object> config) {
        ...
        Caffeine<Object, Object> cache = Caffeine.newBuilder().maximumSize(maxSize).expireAfterWrite(maxTimeRetain,
                TimeUnit.MINUTES);
