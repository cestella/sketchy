...
import com.caseystella.stellar.common.system.Environment;
...
public class SystemFunctions {
  ...
  @Stellar(namespace = "SYSTEM", name = "ENV_GET",
      description = "Returns the value associated with an environment variable",
      params = {"env_var - Environment variable name to get the value for"}, returns = "String")
  ...
  /**
   * Extract type-checked value from an argument list using the specified type check and extraction
   * function
   *
  ...
  @Stellar(namespace = "SYSTEM", name = "PROPERTY_GET",
      description = "Returns the value associated with a Java system property",
      params = {"key - Property to get the value for"}, returns = "String")
  public static class PropertyGet extends BaseStellarFunction {
    @Override
    public Object apply(List<Object> args) {
      return extractTypeChecked(args, 0, String.class,
          x -> System.getProperty((String) args.get(0)));
    }
  }
}
