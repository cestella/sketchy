...
public class DefaultStellarStatefulExecutor implements StellarStatefulExecutor, Serializable {
    ...
    /**
     * Provides additional context for initializing certain Stellar functions. For example, references to Zookeeper or
     * HBase.
     */
    ...
    /**
     * @param initialState
     *            Initial state loaded into the execution environment.
     */
    ...
    /**
     * Execute an expression and assign the result to a variable. The variable is maintained in the context of this
     * executor and is available to all subsequent expressions.
     *
     * @param variable
     ...
     *            Additional state available to the expression. This most often represents the values available to the
     *            expression from an individual message. The state maps a variable name to a variable's value.
     */
    @Override
    ...
    /**
     * Execute a Stellar expression and return the result. The internal state of the executor is not modified.
     *
     * @param expression
     *            The expression to execute.
     * @param state
     ...
     *            expression from an individual message. The state maps a variable name to a variable's value.
     * @param clazz
     *            The expected type of the expression's result.
     * @param <T>
     *            The expected type of the expression's result.
     */
    @Override
