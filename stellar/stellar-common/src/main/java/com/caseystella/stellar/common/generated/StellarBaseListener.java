...
/**
 * This class provides an empty implementation of {@link StellarListener}, which can be extended to
...
public class StellarBaseListener implements StellarListener {
   ...
   */
  @Override
  public void enterComparisonExpressionParens(
      StellarParser.ComparisonExpressionParensContext ctx) {}
