...
/**
 * The Stellar Predicate Processor is intended to allow for specific predicate transformations using
 * the Stellar domain specific language. In contrast to the StellarProcessor, which is a general
 * purpose transformation tool, the output of the stellar statement is always a boolean. In java
 * parlance, this is like a java.util.function.Predicate
 */
...
public class StellarPredicateProcessor extends BaseStellarProcessor<Boolean> {
  ...
  @Override
  public Boolean parse(String rule, VariableResolver variableResolver,
    ...
    try {
      ...
      throw new IllegalArgumentException(
          String.format("The rule '%s' does not return a boolean value.", rule), e);
    } catch (Exception e) {
