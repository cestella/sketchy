...
public class DataStructureFunctions {
    ...
    @Stellar(name = "ADD", namespace = "BLOOM", description = "Adds an element to the bloom filter passed in", params = {
            "bloom - The bloom filter", "value(s) - The value(s) to add" }, returns = "Bloom Filter")
    ...
    @Stellar(name = "EXISTS", namespace = "BLOOM", description = "If the bloom filter contains the value", params = {
            "bloom - The bloom filter",
            "value - The value to check" }, returns = "True if the filter might contain the value and false otherwise")
    ...
    @Stellar(name = "INIT", namespace = "BLOOM", description = "Returns an empty bloom filter", params = {
            "expectedInsertions - The expected insertions",
            "falsePositiveRate - The false positive rate you are willing to tolerate" }, returns = "Bloom Filter")
    ...
    @Stellar(name = "MERGE", namespace = "BLOOM", description = "Returns a merged bloom filter", params = {
            "bloomfilters - A list of bloom filters to merge" }, returns = "Bloom Filter or null if the list is empty")
    ...
    @Stellar(name = "IS_EMPTY", description = "Returns true if string or collection is empty or null and false if otherwise.", params = {
            "input - Object of string or collection type (for example, list)" }, returns = "True if the string or collection is empty or null and false if otherwise.")
    ...
    @Stellar(name = "ADD", namespace = "LIST", description = "Adds an element to a list.", params = {
            "list - List to add element to.",
            "element - Element to add to list" }, returns = "Resulting list with the item added at the end.")
    ...
    @Stellar(name = "LENGTH", description = "Returns the length of a string or size of a collection. Returns 0 for empty or null Strings", params = {
            "input - Object of string or collection type (e.g. list)" }, returns = "Integer")
