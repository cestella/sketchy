...
public class StellarFunctionInfo {
    ...
    public StellarFunctionInfo(String description, String name, String[] params, String returns,
            StellarFunction function) {
    ...
    public boolean equals(Object o) {
        ...
        if (description != null ? !description.equals(that.description) : that.description != null)
            return false;
        if (returns != null ? !returns.equals(that.returns) : that.returns != null)
            return false;
    ...
    public String toString() {
        return "StellarFunctionInfo{" + "name='" + name + '\'' + ", description='" + description + '\'' + ", returns='"
                + returns + '\'' + ", params=" + Arrays.toString(params) + ", function=" + function + '}';
    }
}
