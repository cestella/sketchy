...
public class DefaultHasher implements Hasher {
     ...
     * 
     * @param algorithm
     *            The algorithm used when hashing a value.
     * @param encoder
     *            The encoder to use to encode the hashed value.
     * @param charset
     *            The charset that will be used during hashing and encoding.
     ...
     * {@inheritDoc}
     *
     * Returns a hash which has been encoded using the supplied encoder. If input is null then a string containing all
     * '0' will be returned. The length of the string is determined by the hashing algorithm used.
     * 
     * @param toHash
     *            The value to hash.
     * @return A hash of {@code toHash} that has been encoded.
     * @throws EncoderException
     *             If unable to encode the hash then this exception occurs.
     * @throws NoSuchAlgorithmException
     *             If the supplied algorithm is not known.
     */
    @Override
