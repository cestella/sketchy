...
public class VFSClassloaderUtil {
    ...
    /**
     * Create a FileSystem manager suitable for our purposes. This manager supports files of the following types: * res
     * - resource files * jar * tar * bz2 * tgz * zip * HDFS * FTP * HTTP/S * file
     * 
     * @return vfs
    ...
    /**
     * Create a classloader backed by a virtual filesystem which can handle the following URI types: * res - resource
     * files * jar * tar * bz2 * tgz * zip * HDFS * FTP * HTTP/S * file
     * 
     * @param paths
     *            A set of comma separated paths. The paths are URIs or URIs with a regex pattern at the end.
    ...
    /**
     * Resolve a set of URIs into FileObject objects. This is not recursive. The URIs can refer directly to a file or
     * directory or an optional regex at the end. (NOTE: This is NOT a glob).
     * 
     * @param vfs
     *            The file system manager to use to resolve URIs
     * @param uris
     *            comma separated URIs and URI + globs
     * @return
     * @throws FileSystemException
     */
