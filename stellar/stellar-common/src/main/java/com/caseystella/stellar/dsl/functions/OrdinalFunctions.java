...
public class OrdinalFunctions {
   ...
   * </p>
   */
  @Stellar(name = "MIN", description = "Returns the minimum value of a list of input values",
      params = {"stats - The Stellar statistics object",
  ...
  private static Comparable orderList(Iterable<Comparable> list,
      BiFunction<Comparable, Comparable, Boolean> eval, String funcName) {
