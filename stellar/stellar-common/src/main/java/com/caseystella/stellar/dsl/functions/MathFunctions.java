...
public class MathFunctions {
  ...
  @Stellar(name = "ABS", description = "Returns the absolute value of a number.",
      params = {"number - The number to take the absolute value of"},
  ...
  @Stellar(name = "LOG10", description = "Returns the log (base 10) of a number.",
      params = {"number - The number to take the log (base 10) value of"},
  ...
  @Stellar(name = "LOG2", description = "Returns the log (base 2) of a number.",
      params = {"number - The number to take the log (base 2) value of"},
  ...
  @Stellar(name = "LN", description = "Returns the natural log of a number.",
      params = {"number - The number to take the natural log value of"},
  ...
  @Stellar(name = "SQRT", description = "Returns the square root of a number.",
      params = {"number - The number to take the square root of"},
  ...
  @Stellar(name = "CEILING", description = "Returns the ceiling of a number.",
      params = {"number - The number to take the ceiling of"},
  ...
  @Stellar(name = "FLOOR", description = "Returns the floor of a number.",
      params = {"number - The number to take the floor of"},
  ...
  @Stellar(name = "SIN", description = "Returns the sine of a number.",
      params = {"number - The number to take the sine of"},
  ...
  @Stellar(name = "COS", description = "Returns the cosine of a number.",
      params = {"number - The number to take the cosine of"},
  ...
  @Stellar(name = "TAN", description = "Returns the tangent of a number.",
      params = {"number - The number to take the tangent of"},
  ...
  @Stellar(name = "EXP", description = "Returns Euler's number raised to the power of the argument",
      params = {"number - The power to which e is raised."},
  ...
  @Stellar(name = "IS_NAN",
      ...
      params = {"number - number to evaluate"},
