...
public class StellarProcessorUtils {
     ...
     *
     * <p>
     * This is intended for use while unit testing Stellar expressions. This ensures that the expression validates
     * successfully and produces a result that can be serialized correctly.
     *
     * @param expression
     ...
     *            The expression to execute.
     * @param variables
     *            The variables to expose to the expression.
     * @param context
     *            The execution context.
     * @return The result of executing the expression.
     */
    ...
    private static Object execute(String expression, VariableResolver variableResolver, Context context) {
        ...
        Object result = processor.parse(expression, variableResolver, StellarFunctions.FUNCTION_RESOLVER(), context);
     ...
     *
     * <p>
     * When a Stellar function is used in a Storm topology there are cases when the result needs to be serializable,
     * like when using the Profiler. Storm can use either Kryo or basic Java serialization. It is highly recommended
     * that all Stellar functions return a result that is Kryo serializable to allow for the broadest possible use of
     * the function.
     *
     * @param value
     ...
     * When a Stellar function is used in a Storm topology there are cases when the result needs to be serializable,
     * like when using the Profiler. Storm can use either Kryo or basic Java serialization. It is highly recommended
     * that all Stellar functions return a result that is Java serializable to allow for the broadest possible use of
     * the function.
     *
     * @param value
    ...
    public static void runWithArguments(String function, List<Object> arguments, Object expected) {
        ...
        Map<String, Object> variables = kvStream.get()
    ...
    public static class XRange extends Spliterators.AbstractIntSpliterator {
         ...
         *
         * @param action
         *            to {@code IntConsumer} and passed to {@link #tryAdvance(IntConsumer)}; otherwise the action is
         *            adapted to an instance of {@code IntConsumer}, by boxing the argument of {@code IntConsumer}, and
         *            then passed to {@link #tryAdvance(IntConsumer)}.
         */
        @Override
