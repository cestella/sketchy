...
/**
 * ConcatMap is a lazy concatenation of a list of Maps. It is lazy in that it does not construct a union of all of the
 * maps, but rather keeps the maps separate. Key/Value resolution is done via a first-wins strategy (i.e. the first map
 * which has a key will be used).
 *
...
public class ConcatMap implements Map<String, Object>, Serializable, KryoSerializable {
    ...
    /**
     * This is a lazy entry collection of the associated maps. If there are duplicate keys, they will appear twice here,
     * so be careful.
     * 
     * @return
     */
    ...
    public String toString() {
        Iterable<Iterable<Map.Entry<Object, Object>>> transformed = Iterables.transform(variableMappings,
                x -> x.entrySet());
