...
public class StellarParser extends Parser {
  ...
  public static final int IN = 1, LAMBDA_OP = 2, DOUBLE_QUOTE = 3, SINGLE_QUOTE = 4, COMMA = 5,
      PERIOD = 6, AND = 7, OR = 8, NOT = 9, TRUE = 10, FALSE = 11, EQ = 12, NEQ = 13, LT = 14,
      LTE = 15, GT = 16, GTE = 17, QUESTION = 18, COLON = 19, IF = 20, THEN = 21, ELSE = 22,
      NULL = 23, NAN = 24, MATCH = 25, DEFAULT = 26, MATCH_ACTION = 27, MINUS = 28, PLUS = 29,
      DIV = 30, MUL = 31, LBRACE = 32, RBRACE = 33, LBRACKET = 34, RBRACKET = 35, LPAREN = 36,
      RPAREN = 37, NIN = 38, EXISTS = 39, EXPONENT = 40, INT_LITERAL = 41, DOUBLE_LITERAL = 42,
      FLOAT_LITERAL = 43, LONG_LITERAL = 44, IDENTIFIER = 45, STRING_LITERAL = 46, COMMENT = 47,
      WS = 48;
  public static final int RULE_transformation = 0, RULE_transformation_expr = 1, RULE_if_expr = 2,
      ...
      RULE_kv_list = 15, RULE_map_entity = 16, RULE_arithmetic_expr = 17,
      RULE_arithmetic_expr_mul = 18, RULE_functions = 19, RULE_arithmetic_operands = 20,
      RULE_identifier_operand = 21, RULE_default_operand = 22, RULE_lambda_without_args = 23,
      RULE_lambda_with_args = 24, RULE_lambda_variables = 25, RULE_single_lambda_variable = 26,
      RULE_lambda_variable = 27, RULE_match_expr = 28, RULE_match_clauses = 29,
      RULE_match_clause = 30, RULE_match_clause_action = 31, RULE_match_clause_check = 32;
  public static final String[] ruleNames = {"transformation", "transformation_expr", "if_expr",
      "then_expr", "else_expr", "conditional_expr", "logical_expr", "b_expr", "in_expr",
      "comparison_expr", "transformation_entity", "comp_operator", "func_args", "op_list",
      "list_entity", "kv_list", "map_entity", "arithmetic_expr", "arithmetic_expr_mul", "functions",
      ...
      "match_expr", "match_clauses", "match_clause", "match_clause_action", "match_clause_check"};

  private static final String[] _LITERAL_NAMES =
      {null, null, "'->'", "'\"'", "'''", "','", "'.'", null, null, null, null, null, "'=='",
          "'!='", "'<'", "'<='", "'>'", "'>='", "'?'", "':'", null, null, null, null, "'NaN'", null,
          null, "'=>'", "'-'", "'+'", "'/'", "'*'", "'{'", "'}'", "'['", "']'", "'('", "')'"};
  private static final String[] _SYMBOLIC_NAMES = {null, "IN", "LAMBDA_OP", "DOUBLE_QUOTE",
      "SINGLE_QUOTE", "COMMA", "PERIOD", "AND", "OR", "NOT", "TRUE", "FALSE", "EQ", "NEQ", "LT",
      "LTE", "GT", "GTE", "QUESTION", "COLON", "IF", "THEN", "ELSE", "NULL", "NAN", "MATCH",
      "DEFAULT", "MATCH_ACTION", "MINUS", "PLUS", "DIV", "MUL", "LBRACE", "RBRACE", "LBRACKET",
      "RBRACKET", "LPAREN", "RPAREN", "NIN", "EXISTS", "EXPONENT", "INT_LITERAL", "DOUBLE_LITERAL",
      "FLOAT_LITERAL", "LONG_LITERAL", "IDENTIFIER", "STRING_LITERAL", "COMMENT", "WS"};
  ...
  public final Comp_operatorContext comp_operator() throws RecognitionException {
    ...
    try {
      ...
      enterOuterAlt(_localctx, 1);
      {
        setState(152);
        _la = _input.LA(1);
        if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << EQ) | (1L << NEQ) | (1L << LT)
            | (1L << LTE) | (1L << GT) | (1L << GTE))) != 0))) {
