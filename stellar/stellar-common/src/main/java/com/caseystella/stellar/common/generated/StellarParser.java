...
public class StellarParser extends Parser {
    ...
    public static final int IN = 1, LAMBDA_OP = 2, DOUBLE_QUOTE = 3, SINGLE_QUOTE = 4, COMMA = 5, PERIOD = 6, AND = 7,
            OR = 8, NOT = 9, TRUE = 10, FALSE = 11, EQ = 12, NEQ = 13, LT = 14, LTE = 15, GT = 16, GTE = 17,
            QUESTION = 18, COLON = 19, IF = 20, THEN = 21, ELSE = 22, NULL = 23, NAN = 24, MATCH = 25, DEFAULT = 26,
            MATCH_ACTION = 27, MINUS = 28, PLUS = 29, DIV = 30, MUL = 31, LBRACE = 32, RBRACE = 33, LBRACKET = 34,
            RBRACKET = 35, LPAREN = 36, RPAREN = 37, NIN = 38, EXISTS = 39, EXPONENT = 40, INT_LITERAL = 41,
            DOUBLE_LITERAL = 42, FLOAT_LITERAL = 43, LONG_LITERAL = 44, IDENTIFIER = 45, STRING_LITERAL = 46,
            COMMENT = 47, WS = 48;
    public static final int RULE_transformation = 0, RULE_transformation_expr = 1, RULE_if_expr = 2, RULE_then_expr = 3,
            RULE_else_expr = 4, RULE_conditional_expr = 5, RULE_logical_expr = 6, RULE_b_expr = 7, RULE_in_expr = 8,
            RULE_comparison_expr = 9, RULE_transformation_entity = 10, RULE_comp_operator = 11, RULE_func_args = 12,
            RULE_op_list = 13, RULE_list_entity = 14, RULE_kv_list = 15, RULE_map_entity = 16,
            RULE_arithmetic_expr = 17, RULE_arithmetic_expr_mul = 18, RULE_functions = 19,
            RULE_arithmetic_operands = 20, RULE_identifier_operand = 21, RULE_default_operand = 22,
            RULE_lambda_without_args = 23, RULE_lambda_with_args = 24, RULE_lambda_variables = 25,
            RULE_single_lambda_variable = 26, RULE_lambda_variable = 27, RULE_match_expr = 28, RULE_match_clauses = 29,
            RULE_match_clause = 30, RULE_match_clause_action = 31, RULE_match_clause_check = 32;
    public static final String[] ruleNames = { "transformation", "transformation_expr", "if_expr", "then_expr",
            "else_expr", "conditional_expr", "logical_expr", "b_expr", "in_expr", "comparison_expr",
            "transformation_entity", "comp_operator", "func_args", "op_list", "list_entity", "kv_list", "map_entity",
            "arithmetic_expr", "arithmetic_expr_mul", "functions", "arithmetic_operands", "identifier_operand",
            "default_operand", "lambda_without_args", "lambda_with_args", "lambda_variables", "single_lambda_variable",
            "lambda_variable", "match_expr", "match_clauses", "match_clause", "match_clause_action",
            "match_clause_check" };

    private static final String[] _LITERAL_NAMES = { null, null, "'->'", "'\"'", "'''", "','", "'.'", null, null, null,
            null, null, "'=='", "'!='", "'<'", "'<='", "'>'", "'>='", "'?'", "':'", null, null, null, null, "'NaN'",
            null, null, "'=>'", "'-'", "'+'", "'/'", "'*'", "'{'", "'}'", "'['", "']'", "'('", "')'" };
    private static final String[] _SYMBOLIC_NAMES = { null, "IN", "LAMBDA_OP", "DOUBLE_QUOTE", "SINGLE_QUOTE", "COMMA",
            "PERIOD", "AND", "OR", "NOT", "TRUE", "FALSE", "EQ", "NEQ", "LT", "LTE", "GT", "GTE", "QUESTION", "COLON",
            "IF", "THEN", "ELSE", "NULL", "NAN", "MATCH", "DEFAULT", "MATCH_ACTION", "MINUS", "PLUS", "DIV", "MUL",
            "LBRACE", "RBRACE", "LBRACKET", "RBRACKET", "LPAREN", "RPAREN", "NIN", "EXISTS", "EXPONENT", "INT_LITERAL",
            "DOUBLE_LITERAL", "FLOAT_LITERAL", "LONG_LITERAL", "IDENTIFIER", "STRING_LITERAL", "COMMENT", "WS" };
    ...
    public static class ComparisonExpressionContext extends Transformation_exprContext {
        ...
        public ComparisonExpressionContext(Transformation_exprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class TransformationEntityContext extends Transformation_exprContext {
        ...
        public TransformationEntityContext(Transformation_exprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class TransformationExprContext extends Transformation_exprContext {
        ...
        public TransformationExprContext(Transformation_exprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class MatchExprContext extends Transformation_exprContext {
        ...
        public MatchExprContext(Transformation_exprContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).enterMatchExpr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).exitMatchExpr(this);
        }
    }
    ...
    public static class ComparisonExpressionParensContext extends Comparison_exprContext {
        ...
        public ComparisonExpressionParensContext(Comparison_exprContext ctx) {
            copyFrom(ctx);
        }
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                while (_alt != 2 && _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
                    if (_alt == 1) {
                        ...
                        {
                            {
                                _localctx = new ComparisonExpressionWithOperatorContext(
                                        new Comparison_exprContext(_parentctx, _parentState));
        ...
        try {
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                if (!((((_la) & ~0x3f) == 0 && ((1L << _la)
                        & ((1L << EQ) | (1L << NEQ) | (1L << LT) | (1L << LTE) | (1L << GT) | (1L << GTE))) != 0))) {
                ...
                while (_alt != 2 && _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
                    if (_alt == 1) {
                        ...
                        _prevctx = _localctx;
                        {
                            ...
                            case 1: {
                                _localctx = new ArithExpr_plusContext(
                                        new Arithmetic_exprContext(_parentctx, _parentState));
                                ...
                                break;
                            case 2: {
                                _localctx = new ArithExpr_minusContext(
                                        new Arithmetic_exprContext(_parentctx, _parentState));
                                pushNewRecursionContext(_localctx, _startState, RULE_arithmetic_expr);
                                setState(232);
                                if (!(precpred(_ctx, 1)))
    ...
    public static class ArithExpr_mul_soloContext extends Arithmetic_expr_mulContext {
        ...
        public ArithExpr_mul_soloContext(Arithmetic_expr_mulContext ctx) {
            copyFrom(ctx);
        }
                ...
                while (_alt != 2 && _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
                    if (_alt == 1) {
                        ...
                        _prevctx = _localctx;
                        {
                            ...
                            case 1: {
                                _localctx = new ArithExpr_mulContext(
                                        new Arithmetic_expr_mulContext(_parentctx, _parentState));
                                ...
                                break;
                            case 2: {
                                _localctx = new ArithExpr_divContext(
                                        new Arithmetic_expr_mulContext(_parentctx, _parentState));
                                pushNewRecursionContext(_localctx, _startState, RULE_arithmetic_expr_mul);
                                setState(246);
                                if (!(precpred(_ctx, 1)))
    ...
    public static class NaNArithContext extends Arithmetic_operandsContext {
        ...
        public NaNArithContext(Arithmetic_operandsContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).enterNaNArith(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).exitNaNArith(this);
        }
    }
    ...
    public static class LambdaWithoutArgsExprContext extends Identifier_operandContext {
        ...
        public LambdaWithoutArgsExprContext(Identifier_operandContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class DefaultContext extends Default_operandContext {
        ...
        public DefaultContext(Default_operandContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).enterDefault(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).exitDefault(this);
        }
    }
    ...
    public static class MatchClausesContext extends Match_exprContext {
        ...
        public MatchClausesContext(Match_exprContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).enterMatchClauses(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).exitMatchClauses(this);
        }
    }
    ...
    public static class Match_clausesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).enterMatch_clauses(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).exitMatch_clauses(this);
        }
    }
    ...
    public static class Match_clauseContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).enterMatch_clause(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).exitMatch_clause(this);
        }
    }
    ...
    public static class MatchClauseActionContext extends Match_clause_actionContext {
        ...
        public MatchClauseActionContext(Match_clause_actionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).enterMatchClauseAction(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).exitMatchClauseAction(this);
        }
    }
    ...
    public static class MatchClauseCheckExprContext extends Match_clause_checkContext {
        ...
        public MatchClauseCheckExprContext(Match_clause_checkContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).enterMatchClauseCheckExpr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof StellarListener)
                ((StellarListener) listener).exitMatchClauseCheckExpr(this);
        }
    }
    ...
    public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\62\u0162\4\2\t\2"
