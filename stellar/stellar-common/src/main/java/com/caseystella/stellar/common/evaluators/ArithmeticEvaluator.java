...
public enum ArithmeticEvaluator {
  ...
  public Token<? extends Number> evaluate(
  ...
  /**
   * This is a helper class that defines how to handle arithmetic operations. The conversion between
   * number types is taken for the Java spec:
