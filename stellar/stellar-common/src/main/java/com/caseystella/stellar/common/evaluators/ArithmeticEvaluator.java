...
public enum ArithmeticEvaluator {
    ...
    /**
     * This is a helper class that defines how to handle arithmetic operations. The conversion between number types is
     * taken for the Java spec: http://docs.oracle.com/javase/specs/jls/se8/html/jls-5.html#jls-5.6.2
     */
    public static final class ArithmeticEvaluatorFunctions {
        ...
        public static BiFunction<Number, Number, Token<? extends Number>> multiplication(
                final FrameContext.Context context) {
            return (Number l, Number r) -> {
                if (l instanceof Double || r instanceof Double) {
                    return new Token<>(l.doubleValue() * r.doubleValue(), Double.class, context);
                } else if (l instanceof Float || r instanceof Float) {
