...
public enum NumberLiteralEvaluator {
  ...
  public enum Strategy {
    INTEGER(StellarParser.IntLiteralContext.class, new IntLiteralEvaluator()), DOUBLE(
        StellarParser.DoubleLiteralContext.class, new DoubleLiteralEvaluator()), FLOAT(
            StellarParser.FloatLiteralContext.class, new FloatLiteralEvaluator()), LONG(
                StellarParser.LongLiteralContext.class, new LongLiteralEvaluator());
