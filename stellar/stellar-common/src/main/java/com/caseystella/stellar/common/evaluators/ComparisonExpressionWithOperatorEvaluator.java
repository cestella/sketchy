...
import com.caseystella.stellar.common.FrameContext;
...
public enum ComparisonExpressionWithOperatorEvaluator {
    /**
     * The instance of {@link ComparisonExpressionWithOperatorEvaluator} used in order to evaluate Stellar comparison
     * expressions.
     */
    INSTANCE;

    /**
     * The different strategies used to evaluate a Stellar comparison operator. They are broken into two categories:
     * equality operator comparisons and comparison operator comparisons.
     */
    enum Strategy {
        /**
     ...
     *
     * 1. Testing equality, see {@link EqualityOperatorsEvaluator} 2. Testing not equal, see
     * {@link EqualityOperatorsEvaluator}. This will be the negation of
     * {@link EqualityOperatorsEvaluator#evaluate(Token, Token, StellarParser.ComparisonOpContext)}. 3. Testing less
     * than, less than or equal, greater than, and greater than or equal {@link ComparisonOperatorsEvaluator} 4.
     * Otherwise thrown {@link ParseException}.
     *
     * @param left
     *            The value of the left side of the Stellar expression.
     * @param right
     *            The value of the right side of the Stellar expression.
     * @param op
     *            The operator in the Stellar expression.
    ...
    public Token<Boolean> evaluate(final Token<?> left, final Token<?> right,
        ...
        throw new ParseException("Unsupported operations. The following expression is invalid: " + left.getValue()
                + op.getText() + right.getValue());
    }
}
