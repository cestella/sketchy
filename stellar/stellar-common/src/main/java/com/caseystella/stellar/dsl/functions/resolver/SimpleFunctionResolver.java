...
/**
 * A simple Stellar function resolver that resolves functions from specific classes rather than by
 * searching the classpath.
 *
 * FunctionResolver functionResolver = new SimpleFunctionResolver()
 * .withClass(OneStellarFunction.class) .withClass(AnotherStellarFunction.class)
