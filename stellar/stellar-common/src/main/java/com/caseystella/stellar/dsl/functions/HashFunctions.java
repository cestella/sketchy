...
public class HashFunctions {
    ...
    @Stellar(name = "GET_HASHES_AVAILABLE", description = "Will return all available hashing algorithms available to 'HASH'.", returns = "A list containing all supported hashing algorithms.")
    ...
    @Stellar(name = "HASH", description = "Hashes a given value using the given hashing algorithm and returns a hex encoded string.", params = {
