 ...
 *
 * Provides the additional capabilities expected of executing Stellar in a shell-like environment
 * including maintaining state, variable assignment, magic commands, doc strings, and comments.
 */
