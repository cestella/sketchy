...
public class StellarResult {
     ...
     *
     * A null is a valid result, but cannot be unwrapped from an Optional. Because of this a boolean is used to indicate
     * if the result is a success and the value is null.
     */
     ...
     * @param value
     *            The value of executing the expression.
     */
     ...
     *            Indicates success or failure.
     * @param exception
     *            The exception that occurred when executing the expression.
     */
     ...
     *
     * @param exception
     *            The exception that occurred while executing the expression.
    ...
    /**
     * Indicates an empty result; one that is successful yet has no result. For example, executing a comment.
     *
