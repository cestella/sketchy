...
public class TextFunctions {
    ...
    @Stellar(name = "LANGS", namespace = "FUZZY", description = "Returns a list of IETF BCP 47 available to the system, such as en, fr, de. "
            + "These values may be passed to FUZZY_SCORE", params = {}, returns = "A list of IEF BCP 47 language tag strings")
    /**
    ...
    @Stellar(name = "SCORE", namespace = "FUZZY", description = "Returns the Fuzzy Score which indicates the similarity score between two Strings "
            + "One point is given for every matched character. Subsequent matches yield two bonus "
            + "points. A higher score indicates a higher similarity", params = {
                    ...
                    "string - The IETF BCP 47 language code to use such as en, fr, de "
                            + "( SEE  FUZZY_LANGS  and https://tools.ietf.org/html/bcp47)" }, returns = "integer representing the score")
    /**
