...
public class CachingStellarProcessorTest {
    ...
    public void setup() throws Exception {
        ...
        // create the cache
        Map<String, Object> cacheConfig = ImmutableMap.of(CachingStellarProcessor.MAX_CACHE_SIZE_PARAM, 2,
                CachingStellarProcessor.MAX_TIME_RETAIN_PARAM, 10, CachingStellarProcessor.RECORD_STATS, true);
        cache = CachingStellarProcessor.createCache(cacheConfig);
        contextWithCache = new Context.Builder().with(Context.Capabilities.CACHE, () -> cache).build();
    ...
    public void testInvalidMaxCacheSize() {
        Map<String, Object> cacheConfig = ImmutableMap.of(CachingStellarProcessor.MAX_CACHE_SIZE_PARAM, -1,
    ...
    public void testMissingMaxCacheSize() {
        Map<String, Object> cacheConfig = ImmutableMap.of(CachingStellarProcessor.MAX_TIME_RETAIN_PARAM, 10);
        cache = CachingStellarProcessor.createCache(cacheConfig);
        assertNull(cache);
    }
    ...
    public void testInvalidMaxTimeRetain() {
        Map<String, Object> cacheConfig = ImmutableMap.of(CachingStellarProcessor.MAX_CACHE_SIZE_PARAM, 10,
    ...
    private Object execute(String expression, Context context) {
        ...
        Object result = processor.parse(expression, new MapVariableResolver(fields),
