...
public class StellarResultTest {
  ...
  /**
   * Tests the 'error' method which is used to retrieve a StellarShellResult indicating that an
   * error occurred.
   */
  @Test
  ...
  /**
   * Tests the 'terminate' method which is used to retrieve a StellarShellResult indicating that a
   * termination request was made.
   */
  @Test
  ...
  /**
   * Tests the 'noop' method which is used to retrieve a StellarShellResult indicating that no
   * operation occurred, nor was required.
   */
  @Test
