...
public class DateFunctionsTest {
    ...
    private Object run(String expr) {
        ...
        return processor.parse(expr, new DefaultVariableResolver(x -> variables.get(x), x -> variables.containsKey(x)),
    ...
    /**
     * Test that the String returned is formatted as specified. LocalDate.parse will throw if it is not.
     */
    @Test
