...
public class NetworkFunctionsTest {
  ...
  public void inSubnetTest_positive() {
    StellarProcessorUtils.runWithArguments("IN_SUBNET", ImmutableList.of("192.168.0.1", "192.168.0.0/24"), true);
  }

  @Test
  public void inSubnetTest_negative() {
    StellarProcessorUtils.runWithArguments("IN_SUBNET", ImmutableList.of("192.168.1.1", "192.168.0.0/24"), false);
  }

  @Test
  public void inSubnetTest_multiple() {
    StellarProcessorUtils.runWithArguments("IN_SUBNET", ImmutableList.of("192.168.1.1", "192.168.0.0/24", "192.168.1.0/24"), true);
  }

  @Test
  public void removeSubdomainsTest() {
    StellarProcessorUtils.runWithArguments("DOMAIN_REMOVE_SUBDOMAINS", "www.google.co.uk", "google.co.uk");
    StellarProcessorUtils.runWithArguments("DOMAIN_REMOVE_SUBDOMAINS", "www.google.com", "google.com");
  ...
  public void removeSubdomainsTest_tld_square() {
    ...
    StellarProcessorUtils.runWithArguments("DOMAIN_REMOVE_SUBDOMAINS", "www.subdomain.com.com", "com.com");
  }

  @Test
  public void removeSubdomainsTest_unknowntld() {
    StellarProcessorUtils.runWithArguments("DOMAIN_REMOVE_SUBDOMAINS", "www.subdomain.google.gmail", "google.gmail");
  }
  ...
  public void removeTldTest_tld_square() {
    ...
    StellarProcessorUtils.runWithArguments("DOMAIN_REMOVE_TLD", "www.subdomain.com.com", "www.subdomain.com");
  }

  @Test
  public void removeTldTest_unknowntld() {
    StellarProcessorUtils.runWithArguments("DOMAIN_REMOVE_TLD", "www.subdomain.google.gmail", "www.subdomain.google");
  }
  ...
  public void urlToPortTest() {
    ...
    StellarProcessorUtils.runWithArguments("URL_TO_PORT", "http://www.google.com:7979/foo/bar", 7979);
  }
  ...
  public void urlToHostTest() {
    StellarProcessorUtils.runWithArguments("URL_TO_HOST", "http://www.google.com/foo/bar", "www.google.com");
    StellarProcessorUtils.runWithArguments("URL_TO_HOST", "https://www.google.com/foo/bar", "www.google.com");
    StellarProcessorUtils.runWithArguments("URL_TO_HOST", "http://www.google.com:7979/foo/bar", "www.google.com");
  ...
  public void urlToHostTest_unknowntld() {
    StellarProcessorUtils.runWithArguments("URL_TO_HOST", "http://www.google.gmail/foo/bar", "www.google.gmail");
  }

  @Test
  public void urlToProtocolTest() {
    StellarProcessorUtils.runWithArguments("URL_TO_PROTOCOL", "http://www.google.com/foo/bar", "http");
    StellarProcessorUtils.runWithArguments("URL_TO_PROTOCOL", "https://www.google.com/foo/bar", "https");
  }


  @Test
  public void urlToProtocolTest_unknowntld() {
    StellarProcessorUtils.runWithArguments("URL_TO_PROTOCOL", "http://www.google.gmail/foo/bar", "http");
  }

  @Test
  public void urlToPathTest() {
    StellarProcessorUtils.runWithArguments("URL_TO_PATH", "http://www.google.com/foo/bar", "/foo/bar");
    StellarProcessorUtils.runWithArguments("URL_TO_PATH", "https://www.google.com/foo/bar", "/foo/bar");
  }


  @Test
  public void urlToPathTest_unknowntld() {
    StellarProcessorUtils.runWithArguments("URL_TO_PATH", "http://www.google.gmail/foo/bar", "/foo/bar");
  }
