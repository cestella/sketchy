...
import static com.caseystella.stellar.dsl.functions.resolver.ClasspathFunctionResolver.Config.*;
...
public class ClasspathFunctionResolverTest {
    ...
    public void testExclude() {
        ...
        Properties config = new Properties();
        config.put(STELLAR_SEARCH_EXCLUDES_KEY.param(), "com.caseystella.stellar.*");
