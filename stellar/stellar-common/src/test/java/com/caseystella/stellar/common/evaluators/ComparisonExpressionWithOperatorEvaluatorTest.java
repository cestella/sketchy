...
public class ComparisonExpressionWithOperatorEvaluatorTest {
  ...
  public void unexpectedOperatorShouldThrowException() {
    ...
    ParseException e =
        assertThrows(ParseException.class, () -> evaluator.evaluate(left, right, op, null));
    assertTrue(
        e.getMessage().contains("Unsupported operations. The following expression is invalid: "));
  }
