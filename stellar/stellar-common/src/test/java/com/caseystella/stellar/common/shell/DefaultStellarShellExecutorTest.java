...
public class DefaultStellarShellExecutorTest {
    ...
    public void testAssignmentOfMaps() {
        Map<String, Integer> expected = ImmutableMap.<String, Integer> builder().put("a", 10).put("b", 20).build();
    ...
    /**
     * If the executor is initialized without a connection to Zookeeper, the globals should be defined, but empty. This
     * allows a user to '%define' their own with magic commands even without Zookeeper.
     */
    @Test
