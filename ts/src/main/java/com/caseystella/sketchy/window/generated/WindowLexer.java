...
public class WindowLexer extends Lexer {
  ...
  public static final String[] ruleNames = {"COMMA", "COLON", "WINDOW", "INCLUDE", "EXCLUDE",
      "FROM", "EVERY", "TO", "AGO", "NUMBER", "IDENTIFIER", "DAY_SPECIFIER", "TIME_UNIT", "WS",
      "SECOND_UNIT", "MINUTE_UNIT", "HOUR_UNIT", "DAY_UNIT", "MONDAY", "TUESDAY", "WEDNESDAY",
      "THURSDAY", "FRIDAY", "SATURDAY", "SUNDAY", "CURRENT_DAY_OF_WEEK", "WEEKEND", "WEEKDAY",
      "HOLIDAYS", "DATE", "DIGIT", "FIRST_DIGIT"};
