...
public interface WindowListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by the {@code FromToDuration} labeled alternative in
   * {@link WindowParser#duration}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code FromToDuration} labeled alternative in
   * {@link WindowParser#duration}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code FromDuration} labeled alternative in
   * {@link WindowParser#duration}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code FromDuration} labeled alternative in
   * {@link WindowParser#duration}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code SkipDistance} labeled alternative in
   * {@link WindowParser#skip_distance}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code WindowWidth} labeled alternative in
   * {@link WindowParser#window_width}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code WindowWidth} labeled alternative in
   * {@link WindowParser#window_width}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code TimeInterval} labeled alternative in
   * {@link WindowParser#time_interval}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code TimeAmount} labeled alternative in
   * {@link WindowParser#time_amount}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code TimeAmount} labeled alternative in
   * {@link WindowParser#time_amount}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code TimeUnit} labeled alternative in
   * {@link WindowParser#time_unit}.
   * 
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code TimeUnit} labeled alternative in
   * {@link WindowParser#time_unit}.
   * 
   * @param ctx the parse tree
   */
