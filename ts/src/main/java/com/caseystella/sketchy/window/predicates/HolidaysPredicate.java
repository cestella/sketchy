 ...
 *
 */
package com.caseystella.sketchy.window.predicates;
...
/**
 * A inclusion/exclusion selector predicate that returns true if a timestamp falls on a holiday and false otherwise.
 */
public class HolidaysPredicate implements Predicate<Long> {
    ...
    /**
     * Create a holidays predicate. The arguments are the hierarchical specifier for the holidays (see
     * https://github.com/svendiedrichsen/jollyday/tree/master/src/main/resources/holidays for the hierarchies for your
